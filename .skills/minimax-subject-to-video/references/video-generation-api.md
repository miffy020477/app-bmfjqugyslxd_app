...
| Endpoint | `POST https://app-bmfjqugyslxd-api-oLpZbv47qvea-gateway.appmiaoda.com/v1/video_generation` |
| Auth | `platform_managed`（`X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}`） |
| Content-Type | `application/json` |
| third_part_domain | `app-bmfjqugyslxd-api-oLpZbv47qvea-gateway.appmiaoda.com` |
